export const CTAButton = () => {
  return (
    ...
    >
      <div className="absolute items-center bg-neutral-400 box-border caret-transparent flex h-full justify-center rotate-[23.67719136763623deg] w-full inset-[0%]">
      ...
      <div className="relative text-gray-200 box-border caret-transparent w-full md:w-auto">
        <div className="relative items-center box-border caret-transparent gap-x-2 flex h-full justify-center gap-y-2 w-full z-[1]">
          <img
            src="https://cdn.prod.website-files.com/672a72b52eb5f37692d645a9/672a7a78f544e0c1144890a7_Designmonks.webp"
            alt=""
