import { ContentBlock } from "@/integrations/service-detail/sections/WhySection/components/ContentBlock";
    ...
    <section className="box-border caret-transparent">
      <div className="box-border caret-transparent z-[1] px-5 md:px-[94px]">
        <div className="box-border caret-transparent max-w-[1252px] w-full mx-auto">
          <div className="box-border caret-transparent pt-0 pb-[60px] md:py-[100px]">
            <div className="items-center box-border caret-transparent gap-x-8 flex flex-row-reverse flex-wrap-reverse justify-between gap-y-8 md:flex-nowrap">
              <ContentBlock />
              <div className="relative box-border caret-transparent gap-x-4 hidden shrink-0 h-[560px] max-w-full min-h-0 min-w-0 -order-1 gap-y-4 w-full rounded-2xl md:gap-x-8 md:block md:shrink md:max-w-[610px] md:min-h-[auto] md:min-w-[auto] md:order-none md:gap-y-8">
                <img
                  src="https://cdn.prod.website-files.com/672a72b52eb5f37692d645a9/677d74e1cfd1183d8296f213_Mockups (3).avif"
                  alt="Web Design"
                  className="relative box-border caret-transparent inline-block h-full max-w-full object-cover w-full z-[1] md:object-contain"
                />
                <div className="absolute bg-emerald-400 box-border caret-transparent blur-[150px] h-[181px] max-w-[265px] transform-none w-[100px] z-0 rounded-[265px] left-2/4 top-2/4 md:translate-x-[-50px] md:translate-y-[-90.5px] md:rotate-[-30.00001156757613deg]"></div>
              </div>
            </div>
            <div className="box-border caret-transparent block order-1 mt-6 md:hidden md:order-none md:mt-8">
              ...
              >
                <div className="absolute items-center bg-neutral-400 box-border caret-transparent flex h-full justify-center rotate-[23.67719136763623deg] w-full inset-[0%] md:transform-none">
