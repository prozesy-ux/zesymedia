import { ContactForm } from "@/integrations/service-detail/sections/ContactSection/components/ContactForm";
                    ...
                    <div className="box-border caret-transparent gap-x-2 flex flex-col gap-y-2 md:gap-x-4 md:gap-y-4">
                      ...
                      <div className="box-border caret-transparent gap-x-2 flex flex-col gap-y-2">
                        <div className="items-start box-border caret-transparent gap-x-2 flex justify-start gap-y-2">
                          <img
                            src="https://c.animaapp.com/mlfdffn0RwPDKV/assets/icon-14.svg"
                            alt="Icon"
                    ...
                    <div className="items-start box-border caret-transparent gap-x-3 flex flex-col justify-start gap-y-3 mt-3 md:mt-0">
                      ...
                      <div className="box-border caret-transparent">
                        ...
                        <div className="items-start box-border caret-transparent gap-x-2 flex flex-col justify-start gap-y-2 mt-6">
                          ...
                          >
                            <img
                              src="https://c.animaapp.com/mlfdffn0RwPDKV/assets/icon-15.svg"
                              alt="Icon"
