                ...
                <div className="items-center box-border caret-transparent gap-x-8 flex flex-col justify-start gap-y-8 md:gap-x-14 md:gap-y-14">
                  ...
                  <div className="box-border caret-transparent gap-x-8 grid auto-cols-[1fr] grid-cols-[1fr] grid-rows-[auto] gap-y-8 w-full md:grid-cols-[1fr_1fr_1fr]">
                    <ServiceCard
                      ...
                      description="Through in-depth user research, we ensure flawless navigation, engaging interfaces, and an exceptional experience for users in any device."
                    />
                    <ServiceCard
                      iconUrl="https://cdn.prod.website-files.com/672a72b52eb5f37692d645a9/67b60fce267b8517dd0d3390_Frame (55).webp"
                      iconAlt=""
                      title="Custom Website Design"
                      description="Personalized solutions are created from scratch to align with your brand’s identity and unique business requirements."
                    />
                    <ServiceCard
                      iconUrl="https://cdn.prod.website-files.com/672a72b52eb5f37692d645a9/67b5bc3e5797b542b6d16db8_Frame (40).avif"
                      iconAlt=""
                      title="Landing Page Design"
                      description="High-performing landing pages are one of our sweet spots. We design them with persuasive layouts and actionable CTAs."
                    />
                    <ServiceCard
                      iconUrl="https://cdn.prod.website-files.com/672a72b52eb5f37692d645a9/67b57c4dacc5cc4df3e7adf2_Frame (29).webp"
                      iconAlt=""
                      title="Webflow Website Design"
                      description="We create responsive websites with Webflow’s no-code platform. It ensures scalability, fast deployment, and cutting-edge functionality."
                    />
                    <ServiceCard
                      iconUrl="https://cdn.prod.website-files.com/672a72b52eb5f37692d645a9/67b5bc3e4b468105fbd418a5_Frame (39).webp"
                      iconAlt=""
                      title="Framer Website Design"
                      description="Interactive and visually aesthetic websites come to life with our Framer web design, full of innovative features with no-code solutions."
                    />
                    <ServiceCard
                      iconUrl="https://cdn.prod.website-files.com/672a72b52eb5f37692d645a9/67645313a395db108c0d6266_Frame (6).webp"
                      iconAlt=""
                      title="Website Revamping Services<br />"
                      description="We love to transform your outdated websites with a fresh design. Our design improves user experience and faster performance."
                      hasTitleLineBreak={true}
                    />
                  </div>
                  <a
                    href="/contact"
                      ...
                      <div className="items-center box-border caret-transparent gap-x-2 justify-start gap-y-2 w-screen">
                        ...
                        >
                          <div className="relative box-border caret-transparent z-0 overflow-hidden mt-6 pt-14 md:mt-0">
                            <div
                              role="presentation"
                              className="box-border caret-transparent flex h-full translate-x-[-12944.9px]"
                            >
                              <div
                                role="group"
                                aria-label="1 of 30"
