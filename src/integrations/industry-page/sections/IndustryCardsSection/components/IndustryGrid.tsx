import { IndustryCard } from "@/integrations/industry-page/sections/IndustryCardsSection/components/IndustryCard";

export const IndustryGrid = () => {
  return (
    <div
      role="list"
      className="box-border caret-transparent gap-x-6 grid auto-cols-[1fr] grid-cols-[1fr] grid-rows-[auto] gap-y-6 md:gap-x-8 md:grid-cols-[1fr_1fr_1fr] md:gap-y-[78px]"
    >
      <IndustryCard
      ...
      <IndustryCard
        ...
        imageAlt=""
        imageClassName="aspect-[auto_396_/_256]"
