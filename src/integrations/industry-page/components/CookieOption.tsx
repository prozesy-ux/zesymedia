...
export const CookieOption = (props: CookieOptionProps) => {
  return (
    <div
      className={`relative items-start box-border caret-transparent gap-x-3 flex auto-cols-[1fr] grid-cols-[1fr_0.25fr] grid-rows-[auto] gap-y-3 pb-[5px] ${props.containerVariant || ""}`}
    >
      <label
      ...
      >
        <div
          className={`box-border caret-transparent h-[18px] leading-[normal] w-[18px] border mt-px rounded-[100%] border-solid md:h-[22px] md:w-[22px] ${props.checkboxVariant}`}
        ></div>
