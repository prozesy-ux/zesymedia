import { FooterNewsletter } from "@/integrations/projects/sections/Footer/components/FooterNewsletter";
import { LocationGrid } from "@/integrations/projects/sections/Footer/components/LocationGrid";
import { FooterLinks } from "@/integrations/projects/sections/Footer/components/FooterLinks";
import { FooterBadges } from "@/integrations/projects/sections/Footer/components/FooterBadges";
import { FooterBottom } from "@/integrations/projects/sections/Footer/components/FooterBottom";
              ...
              <div className="box-border caret-transparent gap-x-6 flex flex-col min-h-[auto] min-w-[auto] gap-y-6 md:gap-x-8 md:gap-y-8">
                ...
                <div className="box-border caret-transparent gap-x-4 flex justify-center min-h-[auto] min-w-[auto] gap-y-4">
                  <a
                    ...
                    className="text-violet-600 items-center bg-neutral-900/10 box-border caret-transparent flex h-11 justify-center max-w-11 min-h-[auto] min-w-[auto] decoration-neutral-600 w-full rounded-lg hover:bg-blue-600/20"
                  >
                    <img
