import { FAQItem } from "@/integrations/pricing/sections/FAQ/components/FAQItem";
        ...
        <div className="items-center box-border caret-transparent gap-x-8 flex flex-col justify-start gap-y-8 md:gap-x-14 md:gap-y-14">
          ...
          <div className="box-border caret-transparent flex flex-col max-w-[1038px] min-h-[auto] min-w-[auto] w-full">
            <FAQItem
              ...
              iconUrl="https://c.animaapp.com/mmfqa5b2QIeLaz/assets/icon-22.svg"
              answer={
                "At Prozesy Media, we understand that each project is unique. Usually, our design process takes a few weeks, depending on the project's complexity and scope. We begin with thorough research and planning, followed by design iterations and client feedback sessions. This collaborative approach ensures that the final design aligns perfectly with your vision and goals."
              }
            />
            <FAQItem
            ...
            <FAQItem
              ...
              answer={
                <>
                  <br />
                  Every design project is unique, so pricing varies based on
                  scope, requirements, and expertise needed. For a project, we
                  charge from $5,000 to $100,000. We offer custom pricing
                  personalized according to your specific needs, whether it’s
                  UI/UX, branding, or web design. For an exact quote, contact us
                  for a proposal.
                </>
              }
            />
            ...
            <FAQItem
              ...
              answer={
                <>
                  Yes. Even though we specialize in UI/UX, branding, and product
                  design, we’re also well-versed in WordPress, eCommerce, and
                  app development. Our team is equipped to create responsive
                  WordPress sites, powerful eCommerce platforms, and innovative
                  mobile apps.From design to development, we ensure your digital
                  presence is both visually aesthetic and highly functional on
                  all devices. Prozesy Media offers a full spectrum of services,
