      ...
      <div className="box-border caret-transparent max-w-[1252px] w-full z-[1] mx-auto">
        <div className="box-border caret-transparent gap-x-8 flex flex-col gap-y-8 md:gap-x-14 md:gap-y-14">
            ...
            <div className="box-border caret-transparent min-h-[auto] min-w-[auto]">
              ...
              <div className="items-start box-border caret-transparent gap-x-3.5 flex flex-col gap-y-3.5 capitalize md:gap-x-4 md:gap-y-4">
                <a
                  ...
                  className="text-neutral-400 text-sm items-start box-border caret-transparent gap-x-1 flex justify-end tracking-[0.32px] leading-[21px] max-w-full min-h-[auto] min-w-[auto] gap-y-1 text-left md:text-base md:items-center md:gap-x-1.5 md:justify-start md:leading-6 md:gap-y-1.5 md:text-start"
                >
          ...
          <div className="items-center box-border caret-transparent gap-x-5 flex flex-col justify-start min-h-[auto] min-w-[auto] gap-y-5 md:gap-x-10 md:gap-y-10">
            ...
            <div className="items-center box-border caret-transparent gap-x-8 grid flex-wrap auto-cols-[1fr] grid-cols-[1fr_1fr] grid-rows-[auto_auto] justify-around justify-items-start min-h-[auto] min-w-[auto] gap-y-8 w-full md:gap-x-2 md:flex md:flex-nowrap md:auto-cols-auto md:grid-cols-none md:grid-rows-none md:justify-between md:gap-y-2">
              <a
                href="https://www.framer.com/@design-monks/"
                className="text-neutral-400 text-sm items-start box-border caret-transparent gap-x-1 flex flex-col tracking-[0.32px] leading-[21px] max-w-full min-h-[auto] min-w-[auto] gap-y-1 text-left capitalize md:text-base md:items-center md:gap-x-3.5 md:leading-6 md:gap-y-3.5 md:text-center"
              >
                <div className="text-sm box-border caret-transparent h-[30px] leading-[21px] min-h-[auto] min-w-[auto] text-left overflow-visible md:text-base md:leading-6 md:text-center md:overflow-hidden">
                  <img
                ...
                <div className="text-sm box-border caret-transparent leading-[21px] min-h-[auto] min-w-[auto] text-left md:text-base md:leading-6 md:text-center">
                  Professional partner
                </div>
              </a>
              <a
                href="https://webflow.com/templates/designers/design-monks"
                className="text-neutral-400 text-sm items-start box-border caret-transparent gap-x-1 flex flex-col tracking-[0.32px] leading-[21px] max-w-full min-h-[auto] min-w-[auto] gap-y-1 text-left capitalize md:text-base md:items-center md:gap-x-3.5 md:leading-6 md:gap-y-3.5 md:text-center"
              >
                <div className="text-sm box-border caret-transparent h-[30px] leading-[21px] min-h-[auto] min-w-[auto] text-left overflow-visible md:text-base md:leading-6 md:text-center md:overflow-hidden">
                  <img
              ...
              >
                ...
                <div className="text-sm box-border caret-transparent leading-[21px] min-h-[auto] min-w-[auto] text-left md:text-base md:leading-6 md:text-center">
                  Top Team on Dribbble
                </div>
              </a>
              <a
                href="https://clutch.co/profile/design-monks"
                className="text-neutral-400 text-sm items-start box-border caret-transparent gap-x-1 flex flex-col tracking-[0.32px] leading-[21px] max-w-full min-h-[auto] min-w-[auto] gap-y-1 text-left capitalize md:text-base md:items-center md:gap-x-3.5 md:leading-6 md:gap-y-3.5 md:text-center"
              >
                <div className="text-sm box-border caret-transparent h-[30px] leading-[21px] min-h-[auto] min-w-[auto] text-left overflow-visible md:text-base md:leading-6 md:text-center md:overflow-hidden">
                  <img
                ...
                <div className="text-sm box-border caret-transparent gap-x-0 flex flex-col leading-[21px] min-h-[auto] min-w-[auto] gap-y-0 text-left md:text-base md:gap-x-2.5 md:flex-row md:leading-6 md:gap-y-2.5 md:text-center">
                  <div className="text-sm box-border caret-transparent leading-[21px] min-h-[auto] min-w-[auto] text-left md:text-base md:leading-6 md:text-center">
                    Reviewed on
                  </div>
                  <div className="text-sm items-center box-border caret-transparent flex shrink-0 h-3.5 justify-center leading-[21px] min-h-[auto] min-w-[auto] text-left mt-1 md:text-base md:[align-items:normal] md:block md:shrink md:h-auto md:justify-normal md:leading-6 md:text-center md:mt-0">
                    <img
          ...
          <div className="items-center box-border caret-transparent gap-x-4 flex flex-col justify-center min-h-[auto] min-w-[auto] gap-y-4 mb-5 md:[align-items:normal] md:gap-x-[normal] md:flex-row md:justify-between md:gap-y-[normal] md:mb-8">
            <a
              href="https://www.designmonks.co/terms-and-condition"
              className="text-zinc-50 text-sm items-start box-border caret-transparent gap-x-1 flex justify-end tracking-[0.32px] leading-[21px] max-w-full min-h-[auto] min-w-[auto] gap-y-1 text-left md:text-base md:items-center md:gap-x-1.5 md:justify-start md:leading-6 md:gap-y-1.5 md:text-start"
            >
              <div className="text-sm box-border caret-transparent leading-[21px] min-h-[auto] min-w-[auto] text-left md:text-base md:leading-6 md:text-start">
                Terms &amp; Conditions
              </div>
