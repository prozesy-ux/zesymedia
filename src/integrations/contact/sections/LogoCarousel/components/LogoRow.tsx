  ...
  return (
    <div className="relative box-border caret-transparent z-0 overflow-hidden py-2.5">
      <div role="region" className="relative box-border caret-transparent">
        <div className="relative box-border caret-transparent z-0 overflow-hidden flex">
          <div
            role="presentation"
            className="box-border caret-transparent gap-x-10 flex h-full gap-y-10 animate-marquee md:gap-x-16 md:gap-y-16 min-w-full shrink-0"
          >
            <div
              role="group"
              aria-label="1 of 37"
