import { useState } from "react";
    import { TestimonialTabs } from "@/contact_sections/Testimonials/components/TestimonialTabs";
    import { TestimonialCard, TestimonialData } from "@/contact_sections/Testimonials/components/TestimonialCard";

    const testimonialsData: TestimonialData[] = [
      {
        image: "https://cdn.prod.website-files.com/674703d2af36853f65da67e0/696887601c99f2cd330b64a5_UX _ Design Monks.avif",
        ...
        quote: "Working with Design Monks on our ESDIAC app and group websites was an excellent experience. They were patient, attentive to feedback, and delivered clean, consistent, high-quality work. We’re proud of the results and happy to continue our long-term partnership with them.",
      ...
      },
      {
        ...
        quote: "Had an amazing experience with Design Monks. Their talented team understood my vision and turned it into stunning visuals,with their impressive attention to detail skills. I highly recommend their high-quality design services.",
      ...
      },
      {
        ...
        quote: "Design Monks delivered beautiful, functional UX that truly drove business results. Their expert team blends aesthetics with real business value, boosting our user engagement and growth. Highly recommended!",
      ...
      },
      {
        ...
        quote: "Working with Design Monks transformed our workflow. Their adherence to guidelines increased efficiency and contributed to business growth. We can now focus more on strategic initiatives and client engagement, thanks to saved hours",
      ...
      },
      {
        ...
        quote: "Amazing experience! The Design Monks team is experienced, diligent, and follows a solid process from research to design. They handled our redesign and user feedback perfectly. Truly a standout team in globally.",
