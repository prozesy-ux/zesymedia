import { FAQItem } from "@/aboutdd_sections/FAQSection/components/FAQItem";
            ...
            <div className="items-center box-border caret-transparent gap-x-8 flex flex-col justify-start gap-y-8 md:gap-x-14 md:gap-y-14">
              ...
              <div className="box-border caret-transparent flex flex-col max-w-[1038px] w-full">
                <FAQItem
                  ...
                  answer="At Prozesy Media, we understand that each project is unique. Usually, our design process takes a few weeks, depending on the project's complexity and scope. We begin with thorough research and planning, followed by design iterations and client feedback sessions. This collaborative approach ensures that the final design aligns perfectly with your vision and goals."
                  iconUrl="https://c.animaapp.com/mlf8vhlmD4U7Ki/assets/icon-10.svg"
                />
                <FAQItem
