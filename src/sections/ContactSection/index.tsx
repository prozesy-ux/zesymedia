          ...
          <div className="box-border caret-transparent max-w-[1252px] z-[1] mx-auto">
            <div className="relative bg-neutral-950 box-border caret-transparent w-full mt-0 rounded-2xl md:mt-11 md:rounded-[32px]">
              <div className="relative items-center box-border caret-transparent gap-x-8 flex flex-col auto-cols-[1fr] grid-cols-[1fr] grid-rows-[auto] h-full gap-y-8 z-0 overflow-hidden pt-[60px] pb-8 px-3 rounded-2xl md:[align-items:normal] md:grid md:flex-row md:grid-cols-[1fr_1fr] md:p-16 md:rounded-[32px]">
                  ...
                  <div className="box-border caret-transparent gap-x-5 flex flex-col gap-y-5 md:gap-x-10 md:gap-y-10">
                    <div className="box-border caret-transparent gap-x-2 flex flex-col gap-y-2 md:gap-x-4 md:gap-y-4">
                      <div className="box-border caret-transparent flex">
                        <div className="text-green-500 box-border caret-transparent border border-green-800 px-3 py-1 rounded-3xl border-solid">
                          <div className="text-sm box-border caret-transparent leading-[21px] md:text-base md:leading-6">
                            Claim Free a $999 Brand Growth Consultation, on Us!
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="box-border caret-transparent gap-x-2 flex flex-col gap-y-2">
                        <div className="items-start box-border caret-transparent gap-x-2 flex justify-start gap-y-2">
                          <img
                            src="https://c.animaapp.com/mkiynesyxwO7zZ/assets/icon-27.svg"
                            alt="Icon"
                            className="text-zinc-50 box-border caret-transparent shrink-0 w-5 mt-[3px] md:w-6 md:mt-0.5"
                          />
                    ...
                    <div className="items-start box-border caret-transparent gap-x-3 flex flex-col justify-start gap-y-3 mt-3 md:mt-0">
                      <img
                        src="https://anpeyqpnsavhykstwwbq.supabase.co/storage/v1/object/public/images/c/1770492159840-1.png"
                        alt=""
                        sizes="(max-width: 960px) 100vw, 960px"
                        className="box-border caret-transparent max-w-full w-full rounded-[20px] md:w-60"
                      />
                      <div className="box-border caret-transparent">
                        ...
                        <div className="items-start box-border caret-transparent gap-x-2 flex flex-col justify-start gap-y-2 mt-6">
                          <a
                            href="https://wa.me/+3138803417"
                            className="text-neutral-300 items-center box-border caret-transparent gap-x-2 flex justify-start max-w-full gap-y-2"
                          >
                            <img
                              src="https://www.freeiconspng.com/thumbs/logo-whatsapp-png/download-and-use-logo-whatsapp-png-clipart-16.png"
                              alt="Icon"
                ...
                <img
                  src="https://c.animaapp.com/mkiynesyxwO7zZ/assets/68ba5e44ccb1468ce5b97221_96a931f11af1a2f6b37e251396d130df_6894f274513a65bb1abe220f_Gradient_(1)-p-130x130q80.avif"
                  alt=""
                  className="absolute box-border caret-transparent max-w-full pointer-events-none z-[-1] left-0 right-[0%] top-[0%] md:left-auto"
                />
                <img
                  src="https://c.animaapp.com/mkiynesyxwO7zZ/assets/68ba5e44dc9d7cd13e738839_92c4e6700f092875cffdf04c77a01999_6894f29b7c0ac32bcac50b5f_Gradient_(2)-p-130x130q80.avif"
                  alt=""
            ...
            <div className="relative bg-white shadow-[rgba(15,23,42,0.1)_0px_20px_48px_-12px] box-border caret-transparent border border-neutral-200 overflow-hidden mt-4 px-8 py-3 rounded-[70px] border-solid md:py-4">
              <div className="box-border caret-transparent gap-x-[5px] flex gap-y-[5px] animate-marquee w-max">
                <p className="text-neutral-950 text-lg box-border caret-transparent shrink-0 tracking-[0.48px] leading-[27px] capitalize text-nowrap md:text-2xl md:leading-9">
