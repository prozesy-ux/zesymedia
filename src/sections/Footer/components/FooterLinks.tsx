      ...
      <div className="box-border caret-transparent max-w-[1252px] z-[1] mx-auto">
        <div className="box-border caret-transparent gap-x-8 flex flex-col gap-y-8 md:gap-x-14 md:gap-y-14">
          ...
          <div className="items-center box-border caret-transparent gap-x-5 flex flex-col justify-start gap-y-5 md:gap-x-10 md:gap-y-10">
            ...
            <div className="items-center box-border caret-transparent gap-x-8 grid flex-wrap auto-cols-[1fr] grid-cols-[1fr_1fr] grid-rows-[auto_auto] justify-around justify-items-start gap-y-8 w-full md:gap-x-2 md:flex md:flex-nowrap md:auto-cols-auto md:grid-cols-none md:grid-rows-none md:justify-between md:gap-y-2">
              <a
                href="https://www.framer.com/@design-monks/"
                className="text-neutral-400 text-sm items-start box-border caret-transparent gap-x-1 flex flex-col tracking-[0.32px] leading-[21px] max-w-full gap-y-1 text-left capitalize md:text-base md:items-center md:gap-x-3.5 md:leading-6 md:gap-y-3.5 md:text-center"
              >
              ...
              >
                ...
                <div className="text-sm box-border caret-transparent gap-x-0 flex flex-col leading-[21px] gap-y-0 text-left md:text-base md:gap-x-2.5 md:flex-row md:leading-6 md:gap-y-2.5 md:text-center">
                  <div className="text-sm box-border caret-transparent leading-[21px] text-left md:text-base md:leading-6 md:text-center">
                    Reviewed on
                  </div>
